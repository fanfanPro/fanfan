					...
					<table cellspacing="0" class="infocontent">
						...
						<c:forEach items="${orders }" var="order" varStatus="vs">
									<tr>
										...
										<a href="${pageContext.request.contextPath }/findOrderItemsByOrderIdServlet?orderid=${order.id}" style="display:inline-bock">查看
										</a>&nbsp;&nbsp;<a href="#" style="display:inline-bock">刪除</a></td>
